...
class ModelCheckDate():
    ...
    '''
    def __init__(self):
        #g_const.SCRAPPED_FOLDER = "scrapped"
        #self.WEEK_FILE_PREFIXE = self.SCRAPPED_FOLDER + "/joanna_scrap_"
        pass

    def isWeekPresentInFolder(self, p_date, p_folder, p_ext):
        e_result_to_return = {}
        e_result_to_return['bool'] = False
        e_result_to_return['date'] = ''
    ...
    def _getDateFromFilePath(self, p_file_path):
        #joanna_scrap_ingredients_2022-05-15T22
    ...
    def _listFilesFromFolder(self, p_folder_path : str, p_ext : str = "json"):
        ...
        try:
            e_result_to_return['list'] = [l_file for l_file in listdir(p_folder_path) if self._isFileAndExtMask(p_folder_path, l_file, p_ext)]
            ...
            e_result_to_return['text'] += f">> Les fichiers '.{p_ext}' ont été correctment listés depuis le dossier '{p_folder_path}'"
            e_result_to_return['text'] += "\n"
