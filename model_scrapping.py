...
# secret logins to connect with the foreign apps (Joana's API, personal mail server...)
import config
...
class ModelScrapping:
    ...
    def start(self):
        ...
        try:
            ...
            e_results_to_return['text'] += f">> Erreur de scrapping : {err}"
            e_results_to_return['text'] += "\n"
    ...
    def isWeekPresentInFolder(p_date, p_folder, p_ext):
        return ModelCheckDate.isWeekPresentInFolder(p_date, p_folder, p_ext)
            ...
            for l1_meals in e_infos_week[l0_i]['meals'][1:]:
                ...
                for l2_temp, l2_dish in enumerate(l1_meals['meal']['dishes']):
                    ...
                    for l3_j, l3_ingredient in enumerate(l2_infos_dish['ingredients']):
                        ...
                        e_recettes[l0_i][l0_k]['ingredients'][l3_j]['category'] = l3_ingredient['ingredient'][
                            'category']
                        ...
                        e_recettes[l0_i][l0_k]['ingredients'][l3_j]['unit_of_measure'] = l3_ingredient[
                            'unit_of_measure']
                        l3_temp_time = random.randrange(3)
                        ds.countdown(l3_temp_time, p_step=1, p_show=False, p_space=0)
                        e_text_to_return = e_text_to_return + '    > "' + e_recettes[l0_i][l0_k]['ingredients'][l3_j][
                            'name'] + '"'
